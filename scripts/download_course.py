...
OUT_BASE_DIR = pathlib.Path(__file__).parent.parent / "downloads"
...
def download_discussions(course_name: str, course_id: int) -> Dict[str, int]:
    ...
    disc_dir = OUT_BASE_DIR / course_name / "Discussions"
    ensure_dir(disc_dir)
...
def download_announcements(course_name: str, course_id: int) -> Dict[str, int]:
    ...
    ann_dir = OUT_BASE_DIR / course_name / "Announcements"
    ensure_dir(ann_dir)
...
def download_assignments(course_name: str, course_id: int) -> Dict[str, int]:
    ...
    assign_dir = OUT_BASE_DIR / course_name / "Assignments"
...
def download_course(course_name: str, course_id: int) -> Dict[str, int]:
    ...
    out_dir = OUT_BASE_DIR / course_name
    ensure_dir(out_dir)
...
def main():
    ...
    if args.all:
        ...
        print(f"Saved to: {OUT_BASE_DIR.resolve()}")
        return
    ...
    if args.course_name and args.course_id:
        ...
        print(f"Saved to: {(OUT_BASE_DIR / args.course_name).resolve()}")
